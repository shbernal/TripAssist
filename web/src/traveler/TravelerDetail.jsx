...
import TravelerView from './TravelerView.jsx'
import { StatusBadge } from './Timeline.jsx'
...
export default function TravelerDetail({ state }) {
  const { id } = useParams()
...
function FleetTravelerDetail({ traveler }) {
  return (
    <div className="page">
