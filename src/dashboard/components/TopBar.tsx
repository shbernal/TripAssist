    ...
    <header className="border-b border-slate-800 bg-slate-950/70 backdrop-blur">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-4 py-4 sm:px-6">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-4">
          {/* On phones the badge keeps only the route; the date comes back at sm. */}
          ...
          <button
            type="button"
            onClick={onStartTour}
            className="min-h-10 rounded-lg border border-brand-bright/40 bg-brand-blue/10 px-3 py-1.5 text-sm font-medium text-brand-bright hover:bg-brand-blue/20"
          >
            Visite guidée
          </button>
          <a
            href={STORY_URL}
            className="inline-flex min-h-10 items-center gap-1 text-sm text-slate-400 hover:text-slate-200"
          >
            L’histoire
