...
export const SCENARIOS = {
  'tgv-delay': {
    ...
    affected: [
      ...
      { stepId: 's4', status: 'at_risk', reason: "Aligné sur la nouvelle heure d'arrivée assistée" },
    ],
    plan: [
  ...
  'strike': {
    ...
    plan: [
      { stepId: 's2', action: 'Report sur TGV 6175, place PMR voiture 3', new_time: '12/09 11:03', rationale: 'Prochain TGV avec emplacement UFR garanti' },
      { stepId: 's3', action: "Assistance arrivée Nice-Ville re-planifiée", new_time: '12/09 16:58', rationale: 'Nouvel horaire du train de report' },
      { stepId: 's4', action: 'Taxi adapté re-planifié', new_time: '12/09 17:15', rationale: 'Aligné sur la nouvelle arrivée' },
      { stepId: 's5', action: 'Hôtel Beau Rivage prévenu, chambre 104 maintenue', new_time: '12/09 17:45', rationale: 'Arrivée tardive signalée' },
    ],
    message_voyageur: "Votre train est supprimé à cause d'une grève, mais nous vous avons déjà replacée sur le TGV suivant avec un emplacement adapté. Toute la suite est réajustée.",
  },
  ...
  'elevator': {
    ...
    plan: [
      { stepId: 's3', action: 'Sortie assistée alternative + rampe mobile (itinéraire sans marche validé)', new_time: '12/09 15:05', rationale: 'Ascenseur HS — chemin de plain-pied garanti par un autre accès' },
    ],
    message_voyageur: "Un ascenseur est en panne à Nice, mais un itinéraire sans marche avec rampe et assistance est déjà prévu. Aucun transfert dans les escaliers.",
  },
  ...
  'weather': {
    ...
    plan: [
      { stepId: 's4', action: 'Taxi adapté décalé, itinéraire abrité gare → hôtel', new_time: '12/09 15:40', rationale: 'Créneau ajusté pour éviter le pic orageux' },
    ],
    message_voyageur: "Un orage est annoncé à Nice. Votre taxi adapté est légèrement décalé sur un itinéraire abrité, rien à changer de votre côté.",
  },
  ...
  'taxi-cancel': {
    ...
    plan: [
      { stepId: 's4', action: 'Prestataire PMR alternatif (Riviera Access), véhicule UFR équivalent', new_time: '12/09 15:35', rationale: 'Nouveau véhicule adapté sécurisé' },
    ],
    message_voyageur: "Votre taxi adapté est tombé en panne, mais un véhicule équivalent d'un autre prestataire est déjà réservé. Vous serez prise en charge quasiment à l'heure.",
  },
}
