...
export const CALLS: Record<CallId, CallMeta> = {
  'airport-call': {
    ...
    transcript: {
      ...
      6: "C'est un Permobil M3, cent quarante kilos, équipé d'une batterie Lithium-ion conforme à la réglementation IATA. Nous demandons qu'il voyage en soute et soit restitué en passerelle à l'arrivée à Nice, pas au tapis bagages.",
      7: "C'est parfaitement gérable. Je réserve l'assistance WCHC complète, avec restitution du fauteuil en passerelle à Nice. Je vous donne la référence : whisky-charlie-hôtel neuf-quatre-deux-sept.",
